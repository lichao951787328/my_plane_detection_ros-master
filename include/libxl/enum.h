...
namespace libxl {
    ...
    enum CFormatType { CFORMAT_ABOVEAVERAGE, CFORMAT_BEGINWITH, CFORMAT_CELLIS, CFORMAT_COLORSCALE, CFORMAT_CONTAINSBLANKS, CFORMAT_CONTAINSERRORS, CFORMAT_CONTAINSTEXT, CFORMAT_DATABAR,
                       CFORMAT_DUPLICATEVALUES, CFORMAT_ENDSWITH, CFORMAT_EXPRESSION, CFORMAT_ICONSET, CFORMAT_NOTCONTAINSBLANKS, CFORMAT_NOTCONTAINSERRORS, CFORMAT_NOTCONTAINSTEXT, CFORMAT_TIMEPERIOD,
                       CFORMAT_TOP10, CFORMAT_UNIQUEVALUES};
