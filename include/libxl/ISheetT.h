...
namespace libxl
{
  ...
  virtual             bool XLAPIENTRY removeRow(int rowFirst, int rowLast, bool updateNamedRanges = true) = 0;
        ...
        // virtual ICondFormattingT<TCHAR>* XLAPIENTRY addCondFormatting(const TCHAR* sqref) = 0;

        //virtual              int XLAPIENTRY getActiveCell(int* row, int* col) const = 0;
        //virtual             void XLAPIENTRY setActiveCell(int row, int col) = 0;

        //virtual     const TCHAR* XLAPIENTRY selectionRange() const = 0;
        //virtual             void XLAPIENTRY setSelectionRange()(const TCHAR* sqref) = 0;
